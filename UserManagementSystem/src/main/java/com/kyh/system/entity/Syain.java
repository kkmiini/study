...
public class Syain {
	...
	public LocalDateTime getNyuusyaDate() {
		return nyuusyaDate;
	}
	public void setNyuusyaDate(LocalDateTime nyuusyaDate) {
		this.nyuusyaDate = nyuusyaDate;
	}
	public LocalDateTime getTaisyaDate() {
		return taisyaDate;
	}
	public void setTaisyaDate(LocalDateTime taisyaDate) {
    ...
    private LocalDateTime nyuusyaDate; 
    private LocalDateTime taisyaDate; 	
